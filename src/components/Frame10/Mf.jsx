...
const Mf = () => {
  return (
    ...
    <div className='Mf-content'>
        ...
        <Col lg="3"><Form.Control type="text" placeholder="PAN (not optional)" className='input1' /></Col>
        <Col lg="3"><Form.Control type="text" placeholder="Mobile Number(Not required)" className='input1' /></Col>
        </Row>
